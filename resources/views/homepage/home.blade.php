...
<style>
    ...
    <div style="background-image: url('assets/images/bghome-top.png'); width:100%;height:100%;">
        ...
        <div class="container" style="padding-top : 300px; padding-bottom: 50px">
            <div class="row">
            ...
            <div class="container" style="padding-top : 50px;padding-bottom : 50px;">
                <div class="row">
                    <div class="col-6 col-lg-4" align="center">
                        <div class="card border-0" style="width: 229px;height: 130.39px">
                ...
                <div class="row" style="padding-top : 50px;">
                    <div class="col-6 col-lg-6"align="center">
                        <div class="card border-0"style="width: 229px;height: 130.39px;">
