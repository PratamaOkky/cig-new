            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('tgl_lahir') is-invalid @enderror" id="flatpickr"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('awal_pkwt') is-invalid @enderror" id="flatpickr"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('akhir_pkwt') is-invalid @enderror"
                            id="flatpickr" name="akhir_pkwt" value="{{ old('akhir_pkwt') }}">
                        @error('akhir_pkwt')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
